		...
		?>
                    ...
                    <table width="800" border="0" align="center">
                        <tbody>
                            <tr>
                                ...
                                <td width="518">
                                    <div align="right">
                                        [<a href="frm_addstudent.php">เพิ่มข้อมูลนักเรียน</a>]
                                        [ <a href="showparent.php">จัดการข้อมูลผู้ปกครอง</a> ]
                                    </div>
                                </td>
                            </tr>
                        </tbody>
		  ...
		  ?>
                        <tr>
                            ...
                            <td>
                                <div align="center">
                                    <?php echo "<a href=\"frm_editstudent.php?std_id=$rs[std_id]\">"; ?>แก้ไข</a></div>
                            </td>
                            <td>
                                <div align="center">
                                    <?php echo "<a href=\"frm_deletestudent.php?std_id=$rs[std_id]\">"; ?>ลบ</a></div>
                            </td>
                        </tr>
                        <?php
			}
