		...
		?>
                ...
                <td height="128">
                    ...
                    <table width="800" border="0" align="center">
                        <tr>
                            ...
                            <td>
                                <div align="right">[<a href="frm_addclassroom.php">เพิ่มชั้นเรียน</a>]</div>
                            </td>
                        </tr>
                    </table>
		  ...
		  ?>
                        <tr>
                            ...
                            <td>
                                <div align="center">
                                    <?php echo "<a href=\"frm_addclassroomdetail.php?c_id=$rs[c_id]\">"; ?>จัดการข้อมูลชั้นเรียน</a>
                                </div>
                            </td>
                            <td>
                                <div align="center">
                                    <?php echo "<a href=\"frm_editclassroom.php?c_id=$rs[c_id]\">"; ?>แก้ไข</a></div>
                            </td>
                            <td>
                                <div align="center">
                                    <?php echo "<a href=\"frm_deleteclassroom.php?c_id=$rs[c_id]\">"; ?>ลบ</a></div>
                            </td>
                        </tr>
                        <?php
			}
