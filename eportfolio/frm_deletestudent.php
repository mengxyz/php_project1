    ...
    <table width="832" border="1" align="center">
        ...
        <tr>
            <td>
                <div align="center">
                    <p>&nbsp;</p>
                    <form action="deletestudent.php" method="post" enctype="multipart/form-data" name="form1"
                        id="form1">
                        <table width="375" border="1">
                            ...
                            <tr>
                                ...
                                <td width="227"><input name="std_name" type="text" id="std_name"
                                        value="<?php echo "$rs[std_name]"; ?>" readonly />
                                    <input name="std_id" type="hidden" id="std_id" value="<?php echo "$rs[std_id]"; ?>">
                                    <input name="std_pic" type="hidden" id="std_pic"
                                        value="<?php echo "$rs[std_pic]"; ?>"></td>
                            </tr>
                            <tr>
                                <td height="44">ที่อยู่</td>
                                <td><textarea name="std_address" readonly
                                        id="std_address"><?php echo "$rs[std_address]"; ?></textarea></td>
                            </tr>
                            <tr>
                                <td>เบอร์โทร</td>
                                <td><input name="std_tel" type="text" id="std_tel" value="<?php echo "$rs[std_tel]"; ?>"
                                        readonly></td>
                            </tr>
                            <tr>
				...
				?>
                            ...
                            <tr>
                                <td>ผู้ปกครอง</td>
                                <td>
                                    <select disabled name="pa_id" id="pa_id">                                                                   <?php
                            ...
                            <tr>
                                <td>ชั้นเรียน</td>
                                <td>
                                    <select disabled name="c_id" id="c_id">
                                    <?php
